...
override DEFAULT_FPCDIR=/opt/homebrew/Cellar/fpc/3.2.2_1/lib/fpc/3.2.2/units/aarch64-darwin
ifndef FPC
ifdef PP
FPC=$(PP)
endif
...
override PACKAGE_NAME=pascaltest
override PACKAGE_VERSION=0.1.0
...
ifeq ($(FULL_TARGET),aarch64-darwin)
override COMPILER_TARGETDIR+=build
endif
